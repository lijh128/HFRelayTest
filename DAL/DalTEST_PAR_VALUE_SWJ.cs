...
{
	 	//试验初始命令参数值表上位机
		public partial class DalTEST_PAR_VALUE_SWJ:DbHelperOra
	{
   		     
   		     
   		//Log操作类
        //日志对象
        private static readonly ILog Log = LogManager.GetLogger(typeof(DalTEST_PAR_VALUE_SWJ));
		...
		public bool Exists(string F_TASK_ID,string F_PROGRAM_CODE,string F_SENDPAR_NAME)
		{
		 try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->Exists---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select count(1) from T_TEST_PAR_VALUE_SWJ");
			...
			parameters[2].Value = F_SENDPAR_NAME;
			    ...
			    Log.Info("DalTEST_PAR_VALUE_SWJ->Exists---END");

                return Exists(strSql.ToString(), parameters);
            }
            catch (Exception ex)
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->Exists---FAILED", ex);
                throw ex;
            }
		}
		...
		public void Add(RelayTest.Model.ModelTEST_PAR_VALUE_SWJ model)
		{
		 ...
		 try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->Add---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_TEST_PAR_VALUE_SWJ(");
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->Add---FAILED", ex);
                throw ex;
            }
		}
		...
		public bool Update(RelayTest.Model.ModelTEST_PAR_VALUE_SWJ model)
		{
			...
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->Update---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_TEST_PAR_VALUE_SWJ set ");
...
OracleParameter[] parameters = {
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->Update---FAILED", ex);
                throw ex;
            }
		...
		public bool Delete(string F_TASK_ID,string F_PROGRAM_CODE,string F_SENDPAR_NAME)
		{
			...
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->Delete---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_TEST_PAR_VALUE_SWJ  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_TASK_ID=:F_TASK_ID and F_PROGRAM_CODE=:F_PROGRAM_CODE and F_SENDPAR_NAME=:F_SENDPAR_NAME ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_TASK_ID", OracleType.VarChar,50),
					new OracleParameter(":F_PROGRAM_CODE", OracleType.VarChar,10),
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->Delete---FAILED", ex);
                throw ex;
            }
		...
		public bool Disabled(string F_TASK_ID,string F_PROGRAM_CODE,string F_SENDPAR_NAME)
		{
			...
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->Disabled---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_TEST_PAR_VALUE_SWJ  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_TASK_ID=:F_TASK_ID and F_PROGRAM_CODE=:F_PROGRAM_CODE and F_SENDPAR_NAME=:F_SENDPAR_NAME ");
						OracleParameter[] parameters = {
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->Disabled---FAILED", ex);
                throw ex;
            }
		...
		public bool Enabled(string F_TASK_ID,string F_PROGRAM_CODE,string F_SENDPAR_NAME)
		{
			...
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->Enabled---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_TEST_PAR_VALUE_SWJ  set F_DEL =0, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_TASK_ID=:F_TASK_ID and F_PROGRAM_CODE=:F_PROGRAM_CODE and F_SENDPAR_NAME=:F_SENDPAR_NAME ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_TASK_ID", OracleType.VarChar,50),
					new OracleParameter(":F_PROGRAM_CODE", OracleType.VarChar,10),
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->Enabled---FAILED", ex);
                throw ex;
            }
		...
		public bool Drop(string F_TASK_ID,string F_PROGRAM_CODE,string F_SENDPAR_NAME)
		{
			...
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->Delete---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("DELETE FROM  T_TEST_PAR_VALUE_SWJ  ");
			strSql.Append(" where F_TASK_ID=:F_TASK_ID and F_PROGRAM_CODE=:F_PROGRAM_CODE and F_SENDPAR_NAME=:F_SENDPAR_NAME ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_TASK_ID", OracleType.VarChar,50),
					new OracleParameter(":F_PROGRAM_CODE", OracleType.VarChar,10),
		...
		public bool DeleteWhere(string strWhere )
		{
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->DeleteWhere---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_TEST_PAR_VALUE_SWJ  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->DeleteWhere---FAILED", ex);
                throw ex;
            }
		}
		...
		public bool DropWhere(string strWhere )
		{
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->DropWhere---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from  T_TEST_PAR_VALUE_SWJ  ");
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->DropWhere---FAILED", ex);
                throw ex;
            }
		}
		...
		public RelayTest.Model.ModelTEST_PAR_VALUE_SWJ GetModel(string F_TASK_ID,string F_PROGRAM_CODE,string F_SENDPAR_NAME)
		{
			try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->GetModel---START");
              	StringBuilder strSql=new StringBuilder();
			...
			parameters[2].Value = F_SENDPAR_NAME;
				...
				RelayTest.Model.ModelTEST_PAR_VALUE_SWJ model=new RelayTest.Model.ModelTEST_PAR_VALUE_SWJ();
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->GetModel---FAILED", ex);
                throw ex;
            }
		...
		try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->GetList---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select * ");
				strSql.Append(" FROM T_TEST_PAR_VALUE_SWJ  where 1=1");
				if(strWhere.Trim()!="")
				{
					strSql.Append(" and "+strWhere);
				}
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->GetList---FAILED", ex);
                throw ex;
            }
		...
		try
            {
				...
				strSql.Append(" * ");
				strSql.Append(" FROM T_TEST_PAR_VALUE_SWJ  where F_DEL=0 ");
				if(strWhere.Trim()!="")
				{
					strSql.Append(" and "+strWhere);
				}
        ...
        public bool DropByTaskId(string F_TASK_ID)
        {
            ...
            try
            {
                Log.Info("DalTEST_PAR_VALUE_SWJ->DropByTaskId---START");
                StringBuilder strSql = new StringBuilder();
                strSql.Append("DELETE FROM  T_TEST_PAR_VALUE_SWJ  ");
            ...
            {
                Log.Error("DalTEST_PAR_VALUE_SWJ->DropByTaskId---FAILED", ex);
                throw ex;
            }
        ...
        public DataSet GetListforDis(string strTaskid)
        {
            ...
            strSql.Append(" select   ");
            strSql.Append(" T_TEST_PAR_VALUE_SWJ.F_TASK_ID, ");
            strSql.Append(" T_TEST_PAR_VALUE_SWJ.F_SENDPAR_NAME ,");
            strSql.Append(" T_TEST_PAR_VALUE_SWJ.F_SENDPAR_VALUE, ");
            strSql.Append(" T_PAR_COMMAND_SEND.F_SENDPAR_UNIT, ");
            strSql.Append(" T_PAR_COMMAND_SEND.F_SENDPAR_DEFAULT_VALUE,  ");
            strSql.Append(" T_TEST_PAR_VALUE_SWJ.F_SENDORDER,  ");
            strSql.Append(" T_TEST_PAR_VALUE_SWJ.F_SENDPAR_MEMO   ");
            strSql.Append(" FROM T_TEST_PAR_VALUE_SWJ,T_PAR_COMMAND_SEND ");
            strSql.Append(" WHERE   T_TEST_PAR_VALUE_SWJ.F_SENDPAR_NAME=T_PAR_COMMAND_SEND.F_SENDPAR_NAME    ");
            strSql.Append(" AND T_TEST_PAR_VALUE_SWJ.F_TASK_ID='" + strTaskid + "' ");
