...
{
	 	//线圈电源与负载柜关系
		public partial class DalDEV_COILPOWER_TO_LOAD:DbHelperOra
	{
   		     
   		     
   		//Log操作类
        //日志对象
        private static readonly ILog Log = LogManager.GetLogger(typeof(DalDEV_COILPOWER_TO_LOAD));
		...
		public bool Exists(string F_COILPOWER_ID,string F_LOAD_ID)
		{
		 try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->Exists---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select count(1) from T_DEV_COILPOWER_TO_LOAD");
				strSql.Append(" where 1=1 and ");
				                	                       strSql.Append(" F_COILPOWER_ID = :F_COILPOWER_ID and  ");
			...
			parameters[1].Value = F_LOAD_ID;
			    ...
			    Log.Info("DalDEV_COILPOWER_TO_LOAD->Exists---END");

                return Exists(strSql.ToString(), parameters);
            }
            catch (Exception ex)
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->Exists---FAILED", ex);
                throw ex;
            }
		}
		...
		public void Add(RelayTest.Model.ModelDEV_COILPOWER_TO_LOAD model)
		{
		 ...
		 try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->Add---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_DEV_COILPOWER_TO_LOAD(");			
            strSql.Append("F_COILPOWER_ID,F_COILPOWER_NAME,F_LOAD_ID,F_LOAD_NAME,F_MEMO,F_CREATE_TIME,F_OPERATOR_ID,F_OPERATIONTIME,F_DEL");
            ...
            {
                parameters[1].Value = model.F_COILPOWER_NAME;            }
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->Add---FAILED", ex);
                throw ex;
            }
		}
		...
		public bool Update(RelayTest.Model.ModelDEV_COILPOWER_TO_LOAD model)
		{
			...
			try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->Update---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_DEV_COILPOWER_TO_LOAD set ");
			...
			strSql.Append(" where F_COILPOWER_ID=:F_COILPOWER_ID and F_LOAD_ID=:F_LOAD_ID  ");
...
OracleParameter[] parameters = {
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->Update---FAILED", ex);
                throw ex;
            }
		...
		public bool Delete(string F_COILPOWER_ID,string F_LOAD_ID)
		{
			...
			try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->Delete---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_DEV_COILPOWER_TO_LOAD  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_COILPOWER_ID=:F_COILPOWER_ID and F_LOAD_ID=:F_LOAD_ID ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_COILPOWER_ID", OracleType.VarChar,20),
					new OracleParameter(":F_LOAD_ID", OracleType.VarChar,20)			};
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->Delete---FAILED", ex);
                throw ex;
            }
		...
		public bool Disabled(string F_COILPOWER_ID,string F_LOAD_ID)
		{
			...
			try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->Disabled---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_DEV_COILPOWER_TO_LOAD  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_COILPOWER_ID=:F_COILPOWER_ID and F_LOAD_ID=:F_LOAD_ID ");
						OracleParameter[] parameters = {
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->Disabled---FAILED", ex);
                throw ex;
            }
		...
		public bool Enabled(string F_COILPOWER_ID,string F_LOAD_ID)
		{
			...
			try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->Enabled---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_DEV_COILPOWER_TO_LOAD  set F_DEL =0, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_COILPOWER_ID=:F_COILPOWER_ID and F_LOAD_ID=:F_LOAD_ID ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_COILPOWER_ID", OracleType.VarChar,20),
					new OracleParameter(":F_LOAD_ID", OracleType.VarChar,20)			};
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->Enabled---FAILED", ex);
                throw ex;
            }
		...
		public bool DeleteWhere(string strWhere )
		{
			try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->DeleteWhere---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_DEV_COILPOWER_TO_LOAD  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->DeleteWhere---FAILED", ex);
                throw ex;
            }
		}
		...
		public bool DropWhere(string strWhere )
		{
			try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->DropWhere---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from  T_DEV_COILPOWER_TO_LOAD  ");
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->DropWhere---FAILED", ex);
                throw ex;
            }
		}
		...
		public RelayTest.Model.ModelDEV_COILPOWER_TO_LOAD GetModel(string F_COILPOWER_ID,string F_LOAD_ID)
		{
			try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->GetModel---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select F_COILPOWER_ID, F_COILPOWER_NAME, F_LOAD_ID, F_LOAD_NAME, F_MEMO, F_CREATE_TIME, F_OPERATOR_ID, F_OPERATIONTIME, F_DEL  ");			
				strSql.Append("  from T_DEV_COILPOWER_TO_LOAD ");
				strSql.Append(" where 1=1 AND  F_COILPOWER_ID=:F_COILPOWER_ID and F_LOAD_ID=:F_LOAD_ID ");
							OracleParameter[] parameters = {
					new OracleParameter(":F_COILPOWER_ID", OracleType.VarChar,20),
					new OracleParameter(":F_LOAD_ID", OracleType.VarChar,20)			};
			parameters[0].Value = F_COILPOWER_ID;
			parameters[1].Value = F_LOAD_ID;
				...
				RelayTest.Model.ModelDEV_COILPOWER_TO_LOAD model=new RelayTest.Model.ModelDEV_COILPOWER_TO_LOAD();
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->GetModel---FAILED", ex);
                throw ex;
            }
		...
		try
            {
                Log.Info("DalDEV_COILPOWER_TO_LOAD->GetList---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select * ");
				strSql.Append(" FROM T_DEV_COILPOWER_TO_LOAD  where 1=1");
				if(strWhere.Trim()!="")
				{
					strSql.Append(" and "+strWhere);
				}
            ...
            {
                Log.Error("DalDEV_COILPOWER_TO_LOAD->GetList---FAILED", ex);
                throw ex;
            }
		...
		try
            {
				...
				strSql.Append(" * ");
				strSql.Append(" FROM T_DEV_COILPOWER_TO_LOAD  where F_DEL=0 ");
				if(strWhere.Trim()!="")
				{
					strSql.Append(" and "+strWhere);
				}
