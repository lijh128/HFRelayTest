...
{
	 	//供电柜开关状态转换流水
		public partial class DalFLOW_POWER_SWITCH:DbHelperOra
	{
   		     
   		     
   		//Log操作类
        //日志对象
        private static readonly ILog Log = LogManager.GetLogger(typeof(DalFLOW_POWER_SWITCH));
		...
		public bool Exists(decimal F_ID)
		{
		 try
            {
                Log.Info("DalFLOW_POWER_SWITCH->Exists---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select count(1) from T_FLOW_POWER_SWITCH");
			...
			parameters[0].Value = F_ID;
			    ...
			    Log.Info("DalFLOW_POWER_SWITCH->Exists---END");

                return Exists(strSql.ToString(), parameters);
            }
            catch (Exception ex)
            {
                Log.Error("DalFLOW_POWER_SWITCH->Exists---FAILED", ex);
                throw ex;
            }
		}
		...
		public void Add(RelayTest.Model.ModelFLOW_POWER_SWITCH model)
		{
		 ...
		 try
            {
                Log.Info("DalFLOW_POWER_SWITCH->Add---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_FLOW_POWER_SWITCH(");			
            strSql.Append("F_ID,F_POWER_ID,F_POWER_SWITCH_ID,F_POWER_STATUS,F_MEMO,F_CREATE_TIME,F_OPERATOR_ID,F_OPERATIONTIME,F_DEL");
			...
			OracleParameter[] parameters = {
                        ...
                        new OracleParameter(":F_POWER_STATUS", OracleType.Number,8) ,            
            ...
            {
                parameters[1].Value = model.F_POWER_ID;            }
            ...
            {
                parameters[2].Value = model.F_POWER_SWITCH_ID;            }
                
			if (model.F_POWER_STATUS==null)
			{
            	parameters[3].Value = DBNull.Value;
            }
            else
            {
                parameters[3].Value = model.F_POWER_STATUS;            }
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->Add---FAILED", ex);
                throw ex;
            }
		}
		...
		public bool Update(RelayTest.Model.ModelFLOW_POWER_SWITCH model)
		{
			...
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->Update---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_FLOW_POWER_SWITCH set ");
			                        
            strSql.Append(" F_ID = :F_ID , ");                                    
            strSql.Append(" F_POWER_ID = :F_POWER_ID , ");                                    
            strSql.Append(" F_POWER_SWITCH_ID = :F_POWER_SWITCH_ID , ");                                    
            strSql.Append(" F_POWER_STATUS = :F_POWER_STATUS , ");                                    
...
OracleParameter[] parameters = {
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->Update---FAILED", ex);
                throw ex;
            }
		...
		public bool Delete(decimal F_ID)
		{
			...
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->Delete---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_FLOW_POWER_SWITCH  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_ID=:F_ID ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_ID", OracleType.Number,18)			};
			parameters[0].Value = F_ID;
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->Delete---FAILED", ex);
                throw ex;
            }
		...
		public bool Disabled(decimal F_ID)
		{
			...
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->Disabled---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_FLOW_POWER_SWITCH  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_ID=:F_ID ");
						OracleParameter[] parameters = {
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->Disabled---FAILED", ex);
                throw ex;
            }
		...
		public bool Enabled(decimal F_ID)
		{
			...
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->Enabled---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_FLOW_POWER_SWITCH  set F_DEL =0, F_OPERATIONTIME = SYSDATE");
			strSql.Append(" where F_ID=:F_ID ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_ID", OracleType.Number,18)			};
			parameters[0].Value = F_ID;
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->Enabled---FAILED", ex);
                throw ex;
            }
		...
		public bool Drop(decimal F_ID)
		{
			...
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->Delete---START");
              StringBuilder strSql=new StringBuilder();
			strSql.Append("DELETE FROM  T_FLOW_POWER_SWITCH  ");
			strSql.Append(" where F_ID=:F_ID ");
						OracleParameter[] parameters = {
					new OracleParameter(":F_ID", OracleType.Number,18)			};
			parameters[0].Value = F_ID;
		...
		public bool DeleteWhere(string strWhere )
		{
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->DeleteWhere---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("update  T_FLOW_POWER_SWITCH  set F_DEL =1, F_OPERATIONTIME = SYSDATE");
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->DeleteWhere---FAILED", ex);
                throw ex;
            }
		}
		...
		public bool DropWhere(string strWhere )
		{
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->DropWhere---START");
              	StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from  T_FLOW_POWER_SWITCH  ");
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->DropWhere---FAILED", ex);
                throw ex;
            }
		}
		...
		public RelayTest.Model.ModelFLOW_POWER_SWITCH GetModel(decimal F_ID)
		{
			try
            {
                Log.Info("DalFLOW_POWER_SWITCH->GetModel---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select F_ID, F_POWER_ID, F_POWER_SWITCH_ID, F_POWER_STATUS, F_MEMO, F_CREATE_TIME, F_OPERATOR_ID, F_OPERATIONTIME, F_DEL  ");			
				strSql.Append("  from T_FLOW_POWER_SWITCH ");
			...
			parameters[0].Value = F_ID;
				...
				RelayTest.Model.ModelFLOW_POWER_SWITCH model=new RelayTest.Model.ModelFLOW_POWER_SWITCH();
				...
				if(ds.Tables[0].Rows.Count>0)
				{
															if(ds.Tables[0].Rows[0]["F_ID"].ToString()!="")
					{
						model.F_ID=decimal.Parse(ds.Tables[0].Rows[0]["F_ID"].ToString());
																																			...
																																			if(ds.Tables[0].Rows[0]["F_POWER_STATUS"].ToString()!="")
					{
						model.F_POWER_STATUS=decimal.Parse(ds.Tables[0].Rows[0]["F_POWER_STATUS"].ToString());
					}
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->GetModel---FAILED", ex);
                throw ex;
            }
		...
		try
            {
                Log.Info("DalFLOW_POWER_SWITCH->GetList---START");
              	StringBuilder strSql=new StringBuilder();
				strSql.Append("select * ");
				strSql.Append(" FROM T_FLOW_POWER_SWITCH  where 1=1");
				if(strWhere.Trim()!="")
				{
					strSql.Append(" and "+strWhere);
				}
            ...
            {
                Log.Error("DalFLOW_POWER_SWITCH->GetList---FAILED", ex);
                throw ex;
            }
		...
		try
            {
				...
				strSql.Append(" * ");
				strSql.Append(" FROM T_FLOW_POWER_SWITCH  where F_DEL=0 ");
				if(strWhere.Trim()!="")
				{
					strSql.Append(" and "+strWhere);
				}
